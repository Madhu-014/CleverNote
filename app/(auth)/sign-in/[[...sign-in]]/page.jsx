...
import { Lock, Sparkles, Zap, ArrowLeft } from "lucide-react";
...
export default function Page() {
  ...
  return (
    <div className="soft-breathe-fast relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-10">
      ...
      <div className="float-soft absolute -left-20 -top-20 h-72 w-72 rounded-full bg-primary/20 blur-3xl" />
      <div className="float-soft absolute -bottom-20 -right-16 h-72 w-72 rounded-full bg-accent/35 blur-3xl" />
      ...
      <div className="relative mx-auto grid w-full max-w-6xl items-center gap-8 lg:grid-cols-2">
        <section className="reveal-pop panel-luxe hidden rounded-3xl p-8 lg:block">
          ...
          <h1 className="mt-3 text-5xl font-semibold leading-tight">Continue your premium study workflow.</h1>
          <p className="mt-4 text-muted-foreground">Pick up exactly where you left off with AI-assisted notes and organized PDF context.</p>
          <div className="mt-8 space-y-3">
            {[
              [Lock, "Secure authentication powered by Clerk"],
              [Zap, "Fast workspace and file access"],
              [Sparkles, "Contextual AI notes at your fingertips"],
            ].map(([Icon, text], idx) => (
